                                ...
                                <div class="row">
                                    ...
                                    <div class="container">
                                        <div class="form-group">
                                            ...
                                            <input id="header" type="text" name="header" value="{{$about['header']}}"
                                                   placeholder="Текст кнопки" class="form-control">
                                        </div>
                                    </div>
                                    <div class="container">
                                        <div class="form-group">
                                            <label for="sub_text">Текст кнопки</label>
                                            <input id="sub_text" type="text" name="sub_text" value="{{$about['sub_text']}}"
                                                   placeholder="Текст кнопки" class="form-control">
                                        </div>
                                    </div>
                                </div>
